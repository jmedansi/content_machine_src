...
if __name__ == "__main__":
    ...
    render_bar_chart_race(
        ...
        output_path="d:/Content_Machine/machines/facebook-machine/temp/test_bar.mp4",
        duration=4.0,
    )
    ...
    render_stat_counter(
        ...
        output_path="d:/Content_Machine/machines/facebook-machine/temp/test_stats.mp4",
        duration=3.5,
    )
    ...
    render_line_chart(
        ...
        output_path="d:/Content_Machine/machines/facebook-machine/temp/test_line.mp4",
        duration=4.0,
    )
